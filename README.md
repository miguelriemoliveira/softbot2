...
First launch the gazebo simulation:
    ...
    roslaunch softbot2_gazebo softbot2_gazebo.launch 

Then you can spawn the softbot robot:

    roslaunch softbot2_bringup spawn.launch

To visualize with rviz run:

    roslaunch softbot2_bringup visualize.launch
